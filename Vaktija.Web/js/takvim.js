var Takvim = /** @class */ (function () {
    ...
    Takvim.prototype.danas = function () {
        var now = new Date();
        for (var _i = 0, _a = this.vremena; _i < _a.length; _i++) {
            var d = _a[_i];
    ...
    Takvim.prototype.getMjesec = function (mjesec) {
    ...
    Takvim.prototype.getDrzavniPraznik = function () { return null; };
    Takvim.prototype.getVjerskiPraznik = function () { return null; };
    ...
    Takvim.kreirajVaktiju = function () {
        return [
